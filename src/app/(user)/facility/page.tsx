...
const Page = () => {
  return (
    <section className="container mb-28 mt-5">
        ...
        <div className="w-full md:w-1/2">
          <form action="" className="w-full ">
            <div className="md:float-end flex items-center w-full lg:w-[15rem]">
              ...
              <button
                type="submit"
                className="bg-gradient-primary p-3 rounded-r border border-primary btn-shadow"
              >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        <div className="rounded-xl p-3 bg-white border">
          ...
          <div className="flex justify-end">
            <button className="btn-shadow bg-gradient-primary text-white px-5 py-1.5 rounded-full flex items-center gap-x-1">
              Detail
